...
- Literature references! Like videos in Khan Academy

## Chapter 1

- Explanation of algorithm
- Binary search with several examples and implementation. Log2n
- Some beautiful examples to better understand differently growing runtimes
- Refresher on mathematics like logarithms
- Big O explained
- Little inaccurate on worst-case performance? Page 15
- Interesting teaser: Travelling salesman
...
- Recursion
- Differentiation between base case and recursive case
- Stack explanation
- Very much simplified version of the call stack
- Factorial as example. Slightly wrong implementation
- Makes a little hint to tail recursion
